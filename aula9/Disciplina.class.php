<?php
    ...
    class Disciplina{
        ...
        public function atualizarDisciplina(){
            ...
            $stmt = $conexaoBanco->prepare("UPDATE disciplina SET cargaHoraria = :novaCarga, ementa = :novaEmenta WHERE nome = :nome");
            ...
            if(!$resultado){
                echo "<br/>Não foi possível atualizar a disciplina.";
            }else{
                echo "<br/>Disciplina atualizada com sucesso!";
            }
